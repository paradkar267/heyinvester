        ...
        <div className="footer__grid">
          ...
          <div style={{ paddingLeft: 'var(--space-8)' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', marginTop: 'var(--space-4)' }}>
              <a href="https://www.instagram.com/heyinvestor_official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(217,164,65,0.3)', color: 'var(--gold-400)', transition: 'all 0.2s', textDecoration: 'none' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
              </a>
              <a href="https://www.facebook.com/people/Hey-investors/61556059296229/" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(217,164,65,0.3)', color: 'var(--gold-400)', transition: 'all 0.2s', textDecoration: 'none' }}>
              ...
              <a href="https://www.linkedin.com/company/heyinvestor/" target="_blank" rel="noopener noreferrer" style={{ width: '40px', height: '40px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(217,164,65,0.3)', color: 'var(--gold-400)', transition: 'all 0.2s', textDecoration: 'none' }}>
